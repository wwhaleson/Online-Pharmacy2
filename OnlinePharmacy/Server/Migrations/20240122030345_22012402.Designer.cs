...
namespace OnlinePharmacy.Server.Migrations
{
    ...
    [Migration("20240122030345_22012402")]
    partial class _22012402
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlinePharmacy.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "520204d3-d906-4852-86c7-f241ea199fc2",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBIiJUwV2sXQSWuqhmAITA11ukm1mQ1KbTgkvJeUOAgs7qUPiYceel75tWQw7HS1cA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7d189eba-ea59-4dbf-93aa-bbb79bbc2633",
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Delivery", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstimatedDeliveryDate = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(3481),
                            EstimatedDeliveryTime = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(3495),
                            OrderID = 1,
                            StaffID = 1
                        },
                        new
                        {
                            ...
                            DeliveryMethod = "Standard",
                            DeliveryStatus = "Packing",
                            EstimatedDeliveryDate = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(3497),
                            EstimatedDeliveryTime = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(3498),
                            OrderID = 2,
                            StaffID = 1
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.OnlineConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConsultationDateEnd = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3716),
                            ConsultationDateStart = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3716),
                            ...
                            ConsultationTimeEnd = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3715),
                            ConsultationTimeStart = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3714),
                            CustomerID = 1,
                            PharmacistID = 1
                        },
                        new
                        {
                            ...
                            ConsultationDateEnd = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3726),
                            ConsultationDateStart = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3725),
                            ConsultationDiagnosis = "Common cold",
                            ...
                            ConsultationTimeEnd = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3725),
                            ConsultationTimeStart = new DateTime(2024, 1, 22, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(3724),
                            CustomerID = 2,
                            PharmacistID = 1
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            OrderDate = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(4088),
                            OrderTime = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(4090),
                        ...
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            OrderDate = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(4094),
                            OrderTime = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(4095),
                            PaymentType = "Credit Card",
                            StaffID = 2,
                            TotalCost = 25m
                        });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IssueDate = new DateTime(2024, 1, 22, 11, 3, 45, 253, DateTimeKind.Local).AddTicks(4480),
                            OnlineConsultationID = 2
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 1, 23, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(4660),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 1, 23, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(4671),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 1, 23, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(4674),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 1, 23, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(4676),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 1, 23, 3, 3, 45, 253, DateTimeKind.Utc).AddTicks(4679),
