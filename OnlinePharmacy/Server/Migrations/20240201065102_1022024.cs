    ...
    public partial class _1022024 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "391118bd-b4c6-454d-acef-9cf8ac711569", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEEkXzk9M5cmFw8289D7TynEC/YEcR9q5OHIU0Tw9H2td9feNzgzcJLgexvTq4Y3MBw==", null, false, "df78dbf2-e8d3-4bf3-b91d-35d846858287", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1019), new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1018), "Common cold", "Online Call", 40m, "Completed", "Fever, Headache", new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1017), new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1016), 1, 1, null },
                    { 2, new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1028), new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1028), "Common cold", "Online Call", 45.75m, "Completed", "Headache", new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1027), new DateTime(2024, 2, 1, 6, 51, 2, 654, DateTimeKind.Utc).AddTicks(1027), 2, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(1345), new DateTime(2024, 3, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(1352), "Credit Card", 2, 15m },
                    { 2, 2, new DateTime(2024, 3, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(1357), new DateTime(2024, 3, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(1358), "Credit Card", 2, 25m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5m, "Standard", "Packing", new DateTime(2024, 2, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(780), new DateTime(2024, 2, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(794), 1, 1 },
                    { 2, 5m, "Standard", "Packing", new DateTime(2024, 2, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(796), new DateTime(2024, 2, 1, 14, 51, 2, 654, DateTimeKind.Local).AddTicks(796), 2, 1 }
                });
