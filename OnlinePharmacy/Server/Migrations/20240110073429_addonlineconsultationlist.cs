...
{
    /// <inheritdoc />
    public partial class addonlineconsultationlist : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "441dfb97-e6b7-40c8-ae0b-d92d1c08a734", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEAVffpFSqpkVUJ0a+rrYdy3X+cJEA7RuZkTB94IEsCTv/uxmgFxQwwi3hqX0hg4Whg==", null, false, "de233e54-033f-45ec-9ea6-a3152a36872f", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9143), new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9142), null, 1, null, 40m, null, null, new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9142), new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9141), 1, 1, null },
                    { 2, new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9151), new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9150), null, 2, null, null, null, null, new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9149), new DateTime(2024, 1, 10, 7, 34, 29, 420, DateTimeKind.Utc).AddTicks(9149), 2, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 1, 10, 15, 34, 29, 421, DateTimeKind.Local).AddTicks(41), new DateTime(2024, 1, 10, 15, 34, 29, 421, DateTimeKind.Local).AddTicks(43), null, 2, null },
                    { 2, 2, new DateTime(2024, 1, 10, 15, 34, 29, 421, DateTimeKind.Local).AddTicks(47), new DateTime(2024, 1, 10, 15, 34, 29, 421, DateTimeKind.Local).AddTicks(47), null, 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5m, "Standard", "Packing", new DateTime(2024, 1, 10, 15, 34, 29, 420, DateTimeKind.Local).AddTicks(8917), new DateTime(2024, 1, 10, 15, 34, 29, 420, DateTimeKind.Local).AddTicks(8932), 1, null },
                    { 2, 5m, "Standard", "Packing", new DateTime(2024, 1, 10, 15, 34, 29, 420, DateTimeKind.Local).AddTicks(8936), new DateTime(2024, 1, 10, 15, 34, 29, 420, DateTimeKind.Local).AddTicks(8937), 2, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 10, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 1, 10, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 2, new DateTime(2024, 7, 10, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 1, 10, 15, 34, 29, 421, DateTimeKind.Local).AddTicks(495), 2 }
                });
