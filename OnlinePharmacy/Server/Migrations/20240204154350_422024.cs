...
{
    /// <inheritdoc />
    public partial class _422024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "d0e14d62-ce77-470d-8472-5490118e746b", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEF0eDXDKzKLWae6r/AddYGmUOXHJxdD5/s+V1kGIaR6/bC0F6GUG5rUWwzw3E6PztA==", null, false, "ac7ca120-9eb0-42dd-9ab8-4b720589b9d7", false, "admin@localhost.com" },
                    { "fedeeeb4-ae9f-4617-b6dc-6bbbe227b05e", 0, "74d0e3b6-d57c-4cfb-b5c5-4416b5abdfc0", "user@localhost.com", false, "User", "User", false, null, "USER@LOCALHOST.COM", "USER@LOCALHOST.COM", "AQAAAAIAAYagAAAAEBJmry52xR08ZzA8hn1Gbtmtt0SEoX4KP3lF3aQo6v5J6OzMIk+yHlpDiCb8al2d4Q==", null, false, "2c312eba-ca96-4951-a339-e7f46e2ca132", false, "user@localhost.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2723), new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2723), "Common cold", "Online Call", 40m, "Completed", "Fever, Headache", new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2722), new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2722), 1, 1, null },
                    { 2, new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2734), new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2733), "Common cold", "Online Call", 45.75m, "Completed", "Headache", new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2733), new DateTime(2024, 2, 4, 15, 43, 50, 155, DateTimeKind.Utc).AddTicks(2733), 2, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 2, 4, 23, 43, 50, 155, DateTimeKind.Local).AddTicks(3024), new DateTime(2024, 2, 4, 23, 43, 50, 155, DateTimeKind.Local).AddTicks(3025), "Credit Card", 2, 15m },
                    { 2, 2, new DateTime(2024, 2, 4, 23, 43, 50, 155, DateTimeKind.Local).AddTicks(3029), new DateTime(2024, 2, 4, 23, 43, 50, 155, DateTimeKind.Local).AddTicks(3030), "Credit Card", 2, 25m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5m, "Standard", "Packing", new DateTime(2024, 2, 9, 23, 43, 50, 155, DateTimeKind.Local).AddTicks(2569), new DateTime(2024, 2, 5, 4, 43, 50, 155, DateTimeKind.Local).AddTicks(2588), 1, 1 },
                    { 2, 5m, "Standard", "Packing", new DateTime(2024, 2, 9, 23, 43, 50, 155, DateTimeKind.Local).AddTicks(2590), new DateTime(2024, 2, 5, 5, 43, 50, 155, DateTimeKind.Local).AddTicks(2590), 2, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 7, 4, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 2, 4, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 2, new DateTime(2024, 8, 4, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 2, 4, 0, 0, 0, 0, DateTimeKind.Local), 2 }
                });
