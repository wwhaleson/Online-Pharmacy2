    ...
    public partial class newone : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "7d4df01f-5fe2-4090-b3f1-3cb9d35ab91d", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAENUlsw8fOmYKPxWnPsgwe4t7hHbmDN2G/qpLPdtxOAFn6m5cAFJtjW6M5OX139W2sg==", null, false, "86ca0a9f-e56c-4a13-b3da-21185ce7b1f1", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8153), new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8153), "Common cold", "Online Call", 40m, "Completed", "Fever, Headache", new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8152), new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8151), 1, 1, null },
                    { 2, new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8161), new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8161), "Common cold", "Online Call", 45.75m, "Completed", "Headache", new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8160), new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8160), 2, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8643), new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8651), "Credit Card", 2, 15m },
                    { 2, 2, new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8655), new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8656), "Credit Card", 2, 25m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5m, "Standard", "Packing", new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7785), new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7807), 1, 1 },
                    { 2, 5m, "Standard", "Packing", new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7810), new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7811), 2, 1 }
                });
