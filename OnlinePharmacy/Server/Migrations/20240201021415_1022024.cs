...
{
    /// <inheritdoc />
    public partial class _1022024 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "3781efa7-66dc-47f0-860f-e506d04102e4", 0, "21cba61f-6810-4218-b8b3-df243179b954", "admin@localhost.com", false, "Admin", "User", false, null, "ADMIN@LOCALHOST.COM", "ADMIN@LOCALHOST.COM", "AQAAAAIAAYagAAAAEA3MovoYI2SrN1GztTs/P9Mcfm6t+QFgFMjHWMAT0ScC5WnonqZdi5c2OCthplTgyw==", null, false, "071f403a-162b-4335-9e48-5606e02744a0", false, "admin@localhost.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9532), new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9531), "Common cold", "Online Call", 40m, "Completed", "Fever, Headache", new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9531), new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9530), 1, 1, null },
                    { 2, new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9542), new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9541), "Common cold", "Online Call", 45.75m, "Completed", "Headache", new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9540), new DateTime(2024, 2, 1, 2, 14, 14, 924, DateTimeKind.Utc).AddTicks(9540), 2, 1, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 3, 1, 10, 14, 14, 925, DateTimeKind.Local).AddTicks(8), new DateTime(2024, 3, 1, 10, 14, 14, 925, DateTimeKind.Local).AddTicks(16), "Credit Card", 2, 15m },
                    { 2, 2, new DateTime(2024, 3, 1, 10, 14, 14, 925, DateTimeKind.Local).AddTicks(22), new DateTime(2024, 3, 1, 10, 14, 14, 925, DateTimeKind.Local).AddTicks(23), "Credit Card", 2, 25m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5m, "Standard", "Packing", new DateTime(2024, 2, 1, 10, 14, 14, 924, DateTimeKind.Local).AddTicks(9204), new DateTime(2024, 2, 1, 10, 14, 14, 924, DateTimeKind.Local).AddTicks(9219), 1, 1 },
                    { 2, 5m, "Standard", "Packing", new DateTime(2024, 2, 1, 10, 14, 14, 924, DateTimeKind.Local).AddTicks(9222), new DateTime(2024, 2, 1, 10, 14, 14, 924, DateTimeKind.Local).AddTicks(9223), 2, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 7, 1, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 7, 1, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 2, new DateTime(2024, 8, 1, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 7, 1, 0, 0, 0, 0, DateTimeKind.Local), 2 }
                });
