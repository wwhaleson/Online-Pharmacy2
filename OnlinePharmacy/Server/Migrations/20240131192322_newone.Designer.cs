...
namespace OnlinePharmacy.Server.Migrations
{
    ...
    [Migration("20240131192322_newone")]
            ...
            modelBuilder.Entity("OnlinePharmacy.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7d4df01f-5fe2-4090-b3f1-3cb9d35ab91d",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENUlsw8fOmYKPxWnPsgwe4t7hHbmDN2G/qpLPdtxOAFn6m5cAFJtjW6M5OX139W2sg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "86ca0a9f-e56c-4a13-b3da-21185ce7b1f1",
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Delivery", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstimatedDeliveryDate = new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7785),
                            EstimatedDeliveryTime = new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7807),
                            OrderID = 1,
                            StaffID = 1
                        },
                        new
                        {
                            ...
                            DeliveryMethod = "Standard",
                            DeliveryStatus = "Packing",
                            EstimatedDeliveryDate = new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7810),
                            EstimatedDeliveryTime = new DateTime(2024, 2, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(7811),
                            OrderID = 2,
                            StaffID = 1
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.OnlineConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConsultationDateEnd = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8153),
                            ConsultationDateStart = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8153),
                            ...
                            ConsultationTimeEnd = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8152),
                            ConsultationTimeStart = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8151),
                            CustomerID = 1,
                            PharmacistID = 1
                        },
                        new
                        {
                            ...
                            ConsultationDateEnd = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8161),
                            ConsultationDateStart = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8161),
                            ConsultationDiagnosis = "Common cold",
                            ConsultationPlatform = "Online Call",
                            ConsultationPrice = 45.75m,
                            ConsultationStatus = "Completed",
                            ConsultationSymptom = "Headache",
                            ConsultationTimeEnd = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8160),
                            ConsultationTimeStart = new DateTime(2024, 1, 31, 19, 23, 22, 434, DateTimeKind.Utc).AddTicks(8160),
                            CustomerID = 2,
                            PharmacistID = 1
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            OrderDate = new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8643),
                            OrderTime = new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8651),
                        ...
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            OrderDate = new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8655),
                            OrderTime = new DateTime(2024, 3, 1, 3, 23, 22, 434, DateTimeKind.Local).AddTicks(8656),
                            PaymentType = "Credit Card",
                            StaffID = 2,
                            TotalCost = 25m
                        });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PrescriptionID = 1,
                            ExpiryDate = new DateTime(2024, 7, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IssueDate = new DateTime(2024, 7, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            OnlineConsultationID = 1
                        },
                        new
                        {
                            PrescriptionID = 2,
                            ExpiryDate = new DateTime(2024, 8, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IssueDate = new DateTime(2024, 7, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            OnlineConsultationID = 2
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 30, 19, 23, 22, 435, DateTimeKind.Utc).AddTicks(267),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 30, 19, 23, 22, 435, DateTimeKind.Utc).AddTicks(275),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 30, 19, 23, 22, 435, DateTimeKind.Utc).AddTicks(281),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 30, 19, 23, 22, 435, DateTimeKind.Utc).AddTicks(285),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 30, 19, 23, 22, 435, DateTimeKind.Utc).AddTicks(290),
