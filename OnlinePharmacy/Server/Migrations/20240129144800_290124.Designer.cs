...
namespace OnlinePharmacy.Server.Migrations
{
    ...
    [Migration("20240129144800_290124")]
            ...
            modelBuilder.Entity("OnlinePharmacy.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0b9fb03a-bf2c-436a-a71f-e89f367282cb",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMdSU2u80NWp1AKaZdIpMkLhundr2v1hK8Wa9iAWbwETayccqHkFmbonPJUrw2GBQQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c46b0168-dd00-4a87-bd40-aabb32fe2c94",
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Delivery", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstimatedDeliveryDate = new DateTime(2024, 1, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(4979),
                            EstimatedDeliveryTime = new DateTime(2024, 1, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(4996),
                            OrderID = 1,
                            StaffID = 1
                        },
                        new
                        {
                            ...
                            DeliveryMethod = "Standard",
                            DeliveryStatus = "Packing",
                            EstimatedDeliveryDate = new DateTime(2024, 1, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(5001),
                            EstimatedDeliveryTime = new DateTime(2024, 1, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(5002),
                            OrderID = 2,
                            StaffID = 1
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.OnlineConsultation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConsultationDateEnd = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5224),
                            ConsultationDateStart = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5223),
                            ...
                            ConsultationTimeEnd = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5223),
                            ConsultationTimeStart = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5222),
                            CustomerID = 1,
                            PharmacistID = 1
                        },
                        new
                        {
                            ...
                            ConsultationDateEnd = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5232),
                            ConsultationDateStart = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5232),
                            ConsultationDiagnosis = "Common cold",
                            ConsultationPlatform = "Online Call",
                            ConsultationPrice = 45.75m,
                            ConsultationStatus = "Completed",
                            ConsultationSymptom = "Headache",
                            ConsultationTimeEnd = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5231),
                            ConsultationTimeStart = new DateTime(2024, 1, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(5231),
                            CustomerID = 2,
                            PharmacistID = 1
                        });
                });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderID = 1,
                            CustomerID = 1,
                            OrderDate = new DateTime(2024, 2, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(5551),
                            OrderTime = new DateTime(2024, 2, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(5558),
                        ...
                        new
                        {
                            OrderID = 2,
                            CustomerID = 2,
                            OrderDate = new DateTime(2024, 2, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(5562),
                            OrderTime = new DateTime(2024, 2, 29, 22, 48, 0, 98, DateTimeKind.Local).AddTicks(5563),
                            PaymentType = "Credit Card",
                            StaffID = 2,
                            TotalCost = 25m
                        });
            ...
            modelBuilder.Entity("OnlinePharmacy.Shared.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(6013),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(6019),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(6022),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(6025),
                        ...
                        new
                        {
                            ...
                            ProductExpiryDate = new DateTime(2024, 6, 29, 14, 48, 0, 98, DateTimeKind.Utc).AddTicks(6028),
